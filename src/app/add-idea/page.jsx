...
import { 
  Lightbulb, Tag, FileText, Target, 
  DollarSign, Image as ImageIcon, AlertCircle, CheckCircle2, ArrowRight 
} from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 p-6 md:p-10 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 shadow-[0_10px_50px_rgba(0,0,0,0.02)] space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                ...
                <input id="title" name="title" type="text" required placeholder="e.g., Next-gen AI Assistant" className="w-full h-13 pl-12 pr-4 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-full text-sm font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[#00A896] transition-all" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                ...
                <span className="absolute right-5 text-gray-400 text-xs pointer-events-none">▼</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center">
              ...
              <input id="shortDescription" name="shortDescription" type="text" required placeholder="A one-sentence summary of your idea" className="w-full h-13 pl-12 pr-4 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-full text-sm font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[#00A896] transition-all" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                <Tag className="absolute left-4 w-5 h-5 text-gray-400" />
                <input id="tags" name="tags" type="text" placeholder="innovation, tech, startup (comma-separated)" className="w-full h-13 pl-12 pr-4 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-full text-sm font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[#00A896] transition-all" />
              </div>
            </div>

            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-500 dark:text-slate-400 ml-1">Image URL</label>
              <div className="relative flex items-center">
                <ImageIcon className="absolute left-4 w-5 h-5 text-gray-400" />
                <input id="imageUrl" name="imageUrl" type="url" placeholder="https://example.com/image.jpg" className="w-full h-13 pl-12 pr-4 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-full text-sm font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[#00A896] transition-all" />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                ...
                <input id="budget" name="budget" type="text" placeholder="e.g., $10k - $50k" className="w-full h-13 pl-12 pr-4 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-full text-sm font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[#00A896] transition-all" />
              </div>
            </div>

            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-500 dark:text-slate-400 ml-1">Target Audience</label>
              <div className="relative flex items-center">
                <Target className="absolute left-4 w-5 h-5 text-gray-400" />
                <input id="targetAudience" name="targetAudience" type="text" placeholder="Who is this for?" className="w-full h-13 pl-12 pr-4 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-full text-sm font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[#00A896] transition-all" />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative flex items-start">
                ...
                <textarea id="problemStatement" name="problemStatement" rows={3} placeholder="What problem are you solving?" className="w-full pl-12 pr-4 py-3 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-[1.5rem] text-sm font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[#00A896] resize-none transition-all" />
              </div>
            </div>

            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-500 dark:text-slate-400 ml-1">Proposed Solution</label>
              <div className="relative flex items-start">
                <CheckCircle2 className="absolute left-4 top-4 w-5 h-5 text-gray-400" />
                <textarea id="proposedSolution" name="proposedSolution" rows={3} placeholder="How does your idea solve this problem?" className="w-full pl-12 pr-4 py-3 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/80 rounded-[1.5rem] text-sm font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[#00A896] resize-none transition-all" />
              </div>
            </div>
          </div>
          ...
          <div className="pt-4">
            ...
            >
              {loading ? "Submitting Idea..." : <><>Submit Idea to Vault</><ArrowRight className="w-4 h-4" /></>}
            </button>
          </div>
